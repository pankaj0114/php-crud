          ...
          <div class="row gy-6">
            ...
            <div >
              ...
              <select name="states" class="form-select" id="state">
                ...
                <option name="states" value="Punjab" <?php if($states == 'Punjab'){ echo "selected";} ?> >Punjab
                  
               <option  name = "states"value="Haryana" <?php if($states == 'Haryana'){ echo "selected";} ?> >Haryana
                  
                <option  name = " states" value="Delhi" <?php if($states == 'Delhi'){ echo "selected";} ?> >Delhi
                  
                <option  name =" states" value="Goa" <?php if($states == 'Goa'){ echo "selected";} ?> >Goa
